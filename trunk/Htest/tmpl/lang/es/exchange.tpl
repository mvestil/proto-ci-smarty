...
<h3>Centro de Exchange:</h3><br><br>
...
{else}
Actualmente usted no tiene fondos para exchange.<br><br>
{/if}

<h3>Sus Tarifas de Exchange:</h3><br>
<table cellspacing=0 cellpadding=0 border=0><tr><td class=calendartable>
<table cellspacing=1 cellpadding=2 border=0>
<tr>
 <td align=center class=calendartablebg>De / A</td>
{section name=from loop=$exchange}
