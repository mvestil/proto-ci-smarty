	...
	<table cellpadding="0" cellspacing="0" width="100%" height="750">
	 <tr>
	  <td valign="top" align="left">
	   <div class="clear h_30 bgcolor_ggr pad_10_l page" align="left">WITHDRAWALS HISTORY</div>
	   <div class="clear font_13 pad_15_t" align="center">
		  ...
		  <table cellpadding="0" cellspacing="0">
		   <tr>
				<form method=post>
					...
					<td align="left" width="220" class="color_1">
					<div><b>From:</b></div>
					<div class="float_l"><select name=month_from class="select_60">
					...
					<div class="float_l pad_5_l"><select name=day_from class="select_60">
					...
					<div class="float_l pad_5_l"><select name=year_from class="select_60">
					...
					<td align="left" width="220" class="color_1">
					<div><b>To:</b></div>
					<div class="float_l"><select name=month_to class="select_60">
					...
					<div class="float_l pad_5_l"><select name=day_to class="select_60">
					...
					<div class="float_l pad_5_l"><select name=year_to class="select_60">
		...
		{section name=trans loop=$trans}
			 <tr><td colspan="5" height="2"></td></tr>
			 <tr>
			  <td align="left" class="td1"><b>{$trans[trans].transtype}</b>&nbsp;&nbsp;<br />
				<span style="font-size:11px;">{$trans[trans].description}</span></td>
			  <td></td>
			  <td align="right" class="td1">{$currency_sign} {$trans[trans].actual_amount} &nbsp;&nbsp;
				<span><img src="images/{$trans[trans].ec}.gif" /></span></td>
			  <td></td>
