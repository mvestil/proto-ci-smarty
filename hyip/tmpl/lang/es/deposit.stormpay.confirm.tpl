...
{if $settings.dec_stormpay_fee == 1}
   Su depósito se reducirá en 6,9% y 0,69 dólares (StormPay fee)<br><br>

Usted recibirá ${$amount-$amount*6.9/100-0.69|string_format:"%.2f"} Si usted invierte ${$amount}<br>
Usted tendrá que invertir ${$amount*100/93.1+69/93.1|string_format:"%.2f"} Si usted desea recibir ${$amount}<br>
