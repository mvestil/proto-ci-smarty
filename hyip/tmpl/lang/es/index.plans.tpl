...
<tr>
 ...
 <td class=inheader width=200>Cantidad enviada ({$currency_sign})</td>
 <td class=inheader width=100 nowrap><nobr>{$index_plans[plans].period} Ganado (%)</nobr></td>
</tr>
...
<tr>
 <td colspan=3 align=right><a href="javascript:openCalculator('{$index_plans[plans].id}')">Calcular >></a></td>
</tr>
{/if}
</table>
...
<input type=submit value="Depositar" class=sbmt>
