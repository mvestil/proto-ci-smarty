...
{/section}
 ...
 <td>
	  <input type=submit value="Ver" class=sbmt>
 </td>
</tr></table>
</form>
<br><br>
...
{else}
<tr>
 <td colspan=6 align=center>No se encontraron transacciones</td>
</tr>
{/if}
<tr><td colspan=3>&nbsp;</td>
...
{if $qtrans > 0}
<tr>
 <td colspan=2>Total para este período:</td>
...
<table cellspacing=1 cellpadding=2 border=0 width=100%>
<tr>
 <td class=inheader><b>Tipo</b></td>
 <td class=inheader width=200><b>Cantidad</b></td>
 <td class=inheader width=170><b>Fecha</b></td>
</tr>
{if $qtrans > 0}
{section name=trans loop=$trans}
<tr>
