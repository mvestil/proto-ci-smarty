<?php /* Smarty version Smarty-3.1.11, created on 2012-11-14 12:29:53
         compiled from ".\tmpl\calendar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:512850a38ec11548f0-75471490%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a5d784c3470802c2e26f56f98d0e4d8ea501edd' => 
    array (
      0 => '.\\tmpl\\calendar.tpl',
      1 => 1140465552,
      2 => 'file',
  ...
  'nocache_hash' => '512850a38ec11548f0-75471490',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50a38ec13e5256_00410460',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50a38ec13e5256_00410460')) {function content_50a38ec13e5256_00410460($_smarty_tpl) {?><html>
<head>
...
paymentperiod = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['period'], ENT_QUOTES, 'UTF-8', true);?>
'; // 'd' - daily, 'w' - weekly, 'bw' - beweekly, 'm' - monthly, 'y' - yearly
var maxdays = <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['q_days']+$_smarty_tpl->tpl_vars['type']->value['delay'], ENT_QUOTES, 'UTF-8', true);?>
;
var returnprofit = <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['return_profit'], ENT_QUOTES, 'UTF-8', true);?>
;
var compound = <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['use_compound'], ENT_QUOTES, 'UTF-8', true);?>
;
var delay = <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['delay'], ENT_QUOTES, 'UTF-8', true);?>
;
...
<tr>
  <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['period_name'], ENT_QUOTES, 'UTF-8', true);?>
...
<tr>
  <td nowrap>Deposit <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currency_sign']->value, ENT_QUOTES, 'UTF-8', true);?>
