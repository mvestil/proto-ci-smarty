<?php /* Smarty version Smarty-3.1.11, created on 2012-11-05 02:19:48
         compiled from ".\tmpl\withdrawal_history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:109625097224461f805-77529039%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3e92cba41a8a778d75b8c42b3efc2d7563e4b8e3' => 
    array (
      0 => '.\\tmpl\\withdrawal_history.tpl',
      1 => 1351743017,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '109625097224461f805-77529039',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50972244f04f04_24305716',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50972244f04f04_24305716')) {function content_50972244f04f04_24305716($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['trans']->value[$_smarty_tpl->getVariable('smarty')->value['section']['trans']['index']]['actual_amount'], ENT_QUOTES, 'UTF-8', true);?>
  ...
  <?php if ($_smarty_tpl->tpl_vars['trans']->value[$_smarty_tpl->getVariable('smarty')->value['section']['trans']['index']]['transtype']=='Withdrawal request'){?> <a href=?a=cancelwithdraw&id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['trans']->value[$_smarty_tpl->getVariable('smarty')->value['section']['trans']['index']]['id'], ENT_QUOTES, 'UTF-8', true);?>
...
.gif" align=absmiddle hspace=1 height=17> <?php if ($_smarty_tpl->tpl_vars['trans']->value[$_smarty_tpl->getVariable('smarty')->value['section']['trans']['index']]['transtype']=='Withdrawal request'){?> <a href=?a=cancelwithdraw&id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['trans']->value[$_smarty_tpl->getVariable('smarty')->value['section']['trans']['index']]['id'], ENT_QUOTES, 'UTF-8', true);?>
...
<tr>
 <td colspan=3 style="color: gray"><small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['trans']->value[$_smarty_tpl->getVariable('smarty')->value['section']['trans']['index']]['description'], ENT_QUOTES, 'UTF-8', true);?>
</small></td>
</tr>
<?php endfor; endif; ?>
<?php }else{ ?>
